...
export default function NiSun({ variant = "outlined", size = "medium", oneTone = false, color = "#000" }: NextureIconsProps) {
  ...
  if (variant === "outlined") {
    return (
      <Svg
        ...
        fill="none"
      >
        <Circle cx="12" cy="12" r="8" stroke={color} strokeWidth={iconStrokeWidth} />
        <Path
